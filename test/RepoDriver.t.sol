...
contract RepoDriverTest is Test {
    ...
    function testUpdateOwnerByLitWhenSignatureFromCurrentTimestamp() public {
        updateOwnerByLit(1, "name", user, uint32(block.timestamp));
    }

    function testUpdateOwnerByLitRevertsWhenSignatureNewerThanCurrentTimestamp() public {
        uint8 sourceId = 1;
        bytes memory name = "name";
    ...
    function testUpdateOwnerByLitUsingRealOracleResponse() public {
        vm.prank(admin);
        driver.updateLitOracle(0x395E9a1E9D8241da5C9F2751B2D651051f070ef3);
        uint32 timestamp = 1768515022;
        vm.warp(timestamp);
        updateOwnerByLit(
            1,
            "CodeSandwich/test_chainlink",
            0x0123456789abcDEF0123456789abCDef01234567,
            timestamp,
            0x2a87ea023ef7f621da86e57d9bad27371ee21c4e2116f32ef63b8cceb5787126,
            0xb957b2854a4b392835fc5d9d54ada9cd7f6cbe7225f63ff0698b77130a31532a
        );
    }
